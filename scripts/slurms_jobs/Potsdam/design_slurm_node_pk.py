...
# interpreted by train.log_image_every_epoch_pct
LOG_IMAGE_EVERY_EPOCH_PCT = 25
...
# ────────────────────────────────────────────────────────────────
base_grid = {
    "INDIVIDUAL_ENCODER_NAME": ["RNNContextEncoder", "RNNContextEncoderDosing"],  # encoder stuff
...
# ─── fixed hyper-params ─────────────────────────────────────────
EPOCHS={EPOCHS}
LOG_IMAGE_EVERY_EPOCH_PCT={LOG_IMAGE_EVERY_EPOCH_PCT}
...
OVERRIDE=(
  ...
  train.log_image_every_epoch_pct=$LOG_IMAGE_EVERY_EPOCH_PCT
